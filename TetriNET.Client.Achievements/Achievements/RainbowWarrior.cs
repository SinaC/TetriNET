...
namespace TetriNET.Client.Achievements.Achievements
{
    internal class RainbowWarrior : Achievement
    {
        ...
        public override void OnRoundFinished(int lineCompleted, int level, int moveCount, Interfaces.IBoard board, List<Common.DataContracts.Pieces> collapsedPieces)
        {

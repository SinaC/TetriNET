...
namespace TetriNET.WPF_WCF_Client.Views.PartyLine
{
    ...
    public partial class ChatControl : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty ClientProperty = DependencyProperty.Register("ChatClientProperty", typeof(IClient), typeof(ChatControl), new PropertyMetadata(Client_Changed));
        ...
        {
            ChatControl _this = sender as ChatControl;

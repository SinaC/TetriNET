...
namespace TetriNET.WPF_WCF_Client.Views.PartyLine
{
    ...
    /// </summary>
    public partial class PlayersManagerControl : UserControl, INotifyPropertyChanged
    {
        public static readonly DependencyProperty ClientProperty = DependencyProperty.Register("WinListViewClientProperty", typeof(IClient), typeof(PlayersManagerControl), new PropertyMetadata(Client_Changed));
        ...
        {
            PlayersManagerControl _this = sender as PlayersManagerControl;

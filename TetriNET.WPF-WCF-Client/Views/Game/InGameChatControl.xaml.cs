...
namespace TetriNET.WPF_WCF_Client.Views.Game
{
    ...
    public partial class InGameChatControl : UserControl
    {
        ...
        public static readonly DependencyProperty ClientProperty = DependencyProperty.Register("InGameMessagesClientProperty", typeof (IClient), typeof (InGameChatControl), new PropertyMetadata(Client_Changed));
        ...
        {
            InGameChatControl _this = sender as InGameChatControl;
